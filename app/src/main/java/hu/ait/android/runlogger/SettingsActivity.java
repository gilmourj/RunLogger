...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static final String KEY_PREF_UNITS = "units_switch";
    public static final String KEY_PREF_SOCIAL = "pref_social_running";
    public static final String KEY_PREF_CAMERA = "camera_permissions";
